...
<div style="display: flex; flex-wrap: wrap; gap: 20px;">
  ...
  <!-- Hexon Digital -->
  <div style="flex: 1 1 45%; background: #ffffff; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); overflow: hidden; padding: 10px;">
    <a href="https://hexondigital.com/" target="_blank" style="display: flex; align-items: center;">
  ...
  <!-- VNS | Software Agency -->
  <div style="flex: 1 1 45%; background: #ffffff; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); overflow: hidden; padding: 10px;">
    <a href="https://vnstudios.com/" target="_blank" style="display: flex; align-items: center;">
  ...
  <!-- Fiverr -->
  <div style="flex: 1 1 45%; background: #ffffff; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); overflow: hidden; padding: 10px;">
    <a href="https://www.fiverr.com/" target="_blank" style="display: flex; align-items: center;">
